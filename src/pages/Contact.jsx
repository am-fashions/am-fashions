          ...
          <div className="animate-slide-right">
            <div className="bg-accent rounded-3xl p-8 shadow-2xl hover-glow transform transition-all duration-500">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-white text-accent py-3 rounded-2xl font-semibold hover:bg-gray-100 transition-all duration-500 hover:shadow-xl active:scale-95 transform hover:-translate-y-1 relative overflow-hidden group"
                >
